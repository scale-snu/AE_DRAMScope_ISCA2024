...
if __name__ == '__main__':
            ...
            if judge == -1 or judge == 15:
                if vic%2 == 1:
                    if remaps[rev_bit] % 2 == 0:
                        gate_A[wr_pttn] += 1 / N_ROW / N_BIT / 4096 / 2
                    else:
                        gate_B[wr_pttn] += 1 / N_ROW / N_BIT / 4096 / 2
                else:
    ...
    ##############################################
    plt.subplot(121)
    plt.axhline(y=1*0.000000001, color='lightgray', linewidth=0.5)
    plt.axhline(y=2*0.000000001, color='lightgray', linewidth=0.5)
    plt.axhline(y=3*0.000000001, color='lightgray', linewidth=0.5)
    plt.axhline(y=4*0.000000001, color='lightgray', linewidth=0.5)
    plt.title("Data 0", fontsize = 15, weight='bold')
    plt.yticks([i*0.000000001 for i in range(6)], fontsize=10)
    plt.ylim([0, 5*0.000000001])
